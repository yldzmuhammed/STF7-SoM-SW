...
#define USBD_MANUFACTURER_STRING     	"YILDIZ IoT"
#define USBD_PID_HS     							22352
#define USBD_PRODUCT_STRING_HS     		"STF7-SoM"
#define USBD_CONFIGURATION_STRING_HS	"OTAA Device"
#define USBD_INTERFACE_STRING_HS     	"Interface String"
