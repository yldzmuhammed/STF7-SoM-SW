...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : FMC_A20_Pin FMC_A19_Pin FMC_NBL1_Pin FMC_NBL0_Pin 
                           FMC_A21_Pin FMC_D5_Pin FMC_D6_Pin FMC_D8_Pin 
                           FMC_D11_Pin FMC_D4_Pin FMC_D7_Pin FMC_D9_Pin 
                           FMC_D12_Pin FMC_D10_Pin */
  GPIO_InitStruct.Pin = FMC_A20_Pin|FMC_A19_Pin|FMC_NBL1_Pin|FMC_NBL0_Pin 
                          |FMC_A21_Pin|FMC_D5_Pin|FMC_D6_Pin|FMC_D8_Pin 
                          |FMC_D11_Pin|FMC_D4_Pin|FMC_D7_Pin|FMC_D9_Pin 
                          |FMC_D12_Pin|FMC_D10_Pin;
  ...
  /*Configure GPIO pins : FMC_NE_Pin FMC_NWAIT_Pin FMC_D2_Pin FMC_NWE_Pin 
  ...
  /*Configure GPIO pins : SD_CK_Pin SD_D3_Pin SD_D2_Pin SD_D0_Pin */
  GPIO_InitStruct.Pin = SD_CK_Pin|SD_D3_Pin|SD_D2_Pin|SD_D0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pins : FMC_SDNCAS_Pin FMC_SDCLK_Pin FMC_A11_Pin FMC_A13_Pin 
                           FMC_A12_Pin FMC_A10_Pin FMC_A15_Pin FMC_A14_Pin */
  GPIO_InitStruct.Pin = FMC_SDNCAS_Pin|FMC_SDCLK_Pin|FMC_A11_Pin|FMC_A13_Pin 
                          |FMC_A12_Pin|FMC_A10_Pin|FMC_A15_Pin|FMC_A14_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pins : LTDC_B1_Pin LTDC_B0_Pin LTDC_B2_Pin LTDC_B3_Pin 
                           LTDC_G1_Pin LTDC_G3_Pin LTDC_G0_Pin LTDC_R5_Pin 
                           LTDC_R6_Pin LTDC_R4_Pin LTDC_R1_Pin LTDC_R2_Pin */
  GPIO_InitStruct.Pin = LTDC_B1_Pin|LTDC_B0_Pin|LTDC_B2_Pin|LTDC_B3_Pin 
                          |LTDC_G1_Pin|LTDC_G3_Pin|LTDC_G0_Pin|LTDC_R5_Pin 
                          |LTDC_R6_Pin|LTDC_R4_Pin|LTDC_R1_Pin|LTDC_R2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : LTDC_DE_Pin LTDC_B7_Pin LTDC_B6_Pin LTDC_B5_Pin 
  ...
  /*Configure GPIO pins : LTDC_HSYNC_Pin LTDC_G6_Pin LTDC_G5_Pin LTDC_VSYNC_Pin 
                           LTDC_R0_Pin LTDC_CLK_Pin */
  GPIO_InitStruct.Pin = LTDC_HSYNC_Pin|LTDC_G6_Pin|LTDC_G5_Pin|LTDC_VSYNC_Pin 
                          |LTDC_R0_Pin|LTDC_CLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pins : LTDC_G4_Pin LTDC_G2_Pin LTDC_R3_Pin */
  GPIO_InitStruct.Pin = LTDC_G4_Pin|LTDC_G2_Pin|LTDC_R3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF14_LTDC;
  ...
  /*Configure GPIO pin : LTDC_R7_Pin */
