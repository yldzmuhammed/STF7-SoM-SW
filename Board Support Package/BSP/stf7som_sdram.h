/**
  ******************************************************************************
  * @file    stf7som_sdram.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stf7som_sdram.c driver.
  ******************************************************************************
  */ 

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __STF7SOM_SDRAM_H
#define __STF7SOM_SDRAM_H
...
/** @addtogroup STF7SOM_SDRAM
  * @{
  */    

/** @defgroup STF7SOM_SDRAM_Exported_Types STF7SOM_SDRAM Exported Types
  * @{
  */
...
#define REFRESH_COUNT								              ((uint32_t)((1292) << 1))		      /* SDRAM refresh counter (100Mhz SD clock) */
