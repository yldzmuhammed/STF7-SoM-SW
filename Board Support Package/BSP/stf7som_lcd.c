/**
  ...
  ******************************************************************************
  ...
  --------------------------
     ...
     - This driver uses timing and setting for HX8264 LCD.
...
/** @addtogroup STF7SOM_LCD
  * @{
  */

/** @defgroup STF7SOM_LCD_Private_TypesDefinitions STF7SOM_LCD Private Types Definitions
  * @{
  */
/**
  * @}
...
/** @defgroup STF7SOM_LCD_Private_Defines STF7SOM LCD Private Defines
  * @{
  */
...
/** @defgroup STF7SOM_LCD_Private_Macros STF7SOM_LCD Private Macros
  * @{
  */
...
/** @defgroup STF7SOM_LCD_Private_Variables STF7SOM_LCD Private Variables
  * @{
  */
  
/* Default LCD configuration with LCD Layer 1 */
static uint32_t            		                ActiveLayer;
static LCD_DrawPropTypeDef 		                DrawProp[MAX_LAYER_NUMBER];

static TIM_HandleTypeDef 		                htim11;							                  /** backlight pwm timer */
...
/** @defgroup STF7SOM_LCD_Private_FunctionPrototypes STF7SOM_LCD Private Function Prototypes
  * @{
  */
...
/** @defgroup STF7SOM_LCD_Exported_Functions STF7SOM_LCD Exported Functions
  * @{
  */
...
/**
  * @brief  Initializes the LCD Backlight PWM.
  */
static void Init_BacklightPWM(void)
{
...
static void DeInit_BacklightPWM(void)
{
  /* Stop PWM */
...
uint8_t BSP_LCD_Init(void)
{
    ...
    hLtdcHandler.Init.HorizontalSync 		    = HORIZONTAL_SYNC;
    hLtdcHandler.Init.VerticalSync 			    = VERTICAL_SYNC;
    hLtdcHandler.Init.AccumulatedHBP 		    = ACCUMULATED_HBP;
    hLtdcHandler.Init.AccumulatedVBP 		    = ACCUMULATED_VBP;
    hLtdcHandler.Init.AccumulatedActiveW 	  = ACCUMULATED_ACTIVE_W;
    hLtdcHandler.Init.AccumulatedActiveH 	  = ACCUMULATED_ACTIVE_H;
    hLtdcHandler.Init.TotalHeigh 			      = TOTAL_HEIGH;
    hLtdcHandler.Init.TotalWidth 			      = TOTAL_WIDTH;

    /* LCD clock configuration */
    BSP_LCD_ClockConfig(&hLtdcHandler);
...
uint8_t BSP_LCD_DeInit(void)
{
    ...
    BSP_LCD_MspDeInit(&hLtdcHandler);
...
__weak void BSP_LCD_MspInit(LTDC_HandleTypeDef *hltdc)
{
  ...
  */
  ...
  GPIO_InitStruct.Pin         = LTDC_R7_Pin;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  GPIO_InitStruct.Pin         = LTDC_R3_Pin     | LTDC_G2_Pin     | LTDC_G4_Pin;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  GPIO_InitStruct.Pin         = LTDC_R0_Pin     | LTDC_G6_Pin     | LTDC_G5_Pin | LTDC_HSYNC_Pin|
                                LTDC_VSYNC_Pin  | LTDC_CLK_Pin;
  HAL_GPIO_Init(GPIOI, &GPIO_InitStruct);

  GPIO_InitStruct.Pin         = LTDC_R1_Pin     | LTDC_R2_Pin     | LTDC_R4_Pin   | LTDC_R5_Pin | 
                                LTDC_R6_Pin     | LTDC_G0_Pin     | LTDC_G1_Pin   | LTDC_G3_Pin |
                                LTDC_B0_Pin     | LTDC_B1_Pin     | LTDC_B2_Pin   | LTDC_B3_Pin;
  HAL_GPIO_Init(GPIOJ, &GPIO_InitStruct);

  GPIO_InitStruct.Pin         = LTDC_DE_Pin     | LTDC_B7_Pin     | LTDC_B6_Pin   | LTDC_B5_Pin |
                                LTDC_B4_Pin     | LTDC_G7_Pin;
  HAL_GPIO_Init(GPIOK, &GPIO_InitStruct);

  /** GPIO Configuration PI8 */
...
__weak void BSP_LCD_MspDeInit(LTDC_HandleTypeDef *hltdc)
{
    ...
    PJ1     ------> LTDC_R2 
    */
    HAL_GPIO_DeInit(GPIOJ,  LTDC_B1_Pin | LTDC_B0_Pin | LTDC_B2_Pin | LTDC_B3_Pin |
                            LTDC_G1_Pin | LTDC_G3_Pin | LTDC_G0_Pin | LTDC_R5_Pin |
                            LTDC_R6_Pin | LTDC_R4_Pin | LTDC_R1_Pin | LTDC_R2_Pin);

    HAL_GPIO_DeInit(GPIOK,  LTDC_DE_Pin | LTDC_B7_Pin | LTDC_B6_Pin | LTDC_B5_Pin |
                            LTDC_B4_Pin | LTDC_G7_Pin);

    HAL_GPIO_DeInit(GPIOI,  LTDC_HSYNC_Pin | LTDC_G6_Pin | LTDC_G5_Pin | LTDC_VSYNC_Pin |
                            LTDC_R0_Pin | LTDC_CLK_Pin);

    HAL_GPIO_DeInit(GPIOH, LTDC_G4_Pin | LTDC_G2_Pin | LTDC_R3_Pin);

    HAL_GPIO_DeInit(LTDC_R7_GPIO_Port, LTDC_R7_Pin);
...
__weak void BSP_LCD_ClockConfig(LTDC_HandleTypeDef *hltdc)
{
    ...
    /* PLLLCDCLK = PLLSAI_VCO Output/PLLSAIR = 400 / 6 = 66.666 Mhz */
    /* LTDC clock frequency = PLLLCDCLK / LTDC_PLLSAI_DIVR_2 = 66.666 / 2 = 33.333Mhz */
    periph_clk_init_struct.PLLSAI.PLLSAIN 		    = PLLSAIN_CONSTANT;
    periph_clk_init_struct.PLLSAI.PLLSAIR 		    = FREQUENCY_DIVIDER;
    periph_clk_init_struct.PeriphClockSelection     = RCC_PERIPHCLK_LTDC;
    periph_clk_init_struct.PLLSAIDivR 			    = PLLSAIDIVR_CONSTANT;
